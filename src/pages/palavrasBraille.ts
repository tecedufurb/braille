export class palavraBraille { 
  static exemplosImagem = [ 
      ...
      {palavra:'Símbolo não utilizado na Grafia Braille para a Língua Portuguesa', imagem:' '},//è crase ../assets/img/sinais-braille/e-crase.png
      ...
      {palavra:'146', imagem:'../assets/img/sinais-braille-small/146-braille.png'},
      {palavra:'ônibus', imagem:'../assets/img/palavras-braille/onibus.png'},
      {palavra:'leo@gmail.com', imagem:'../assets/img/sinais-braille/arroba-braille.png'},
      ...
      {palavra:'/', imagem:' '},
      {palavra:'?', imagem:' '},
      {palavra:'!', imagem:' '},//caso especial ! e +
      {palavra:'=', imagem:' '},
      {palavra:'multiplicar', imagem:' '},
      {palavra:'*', imagem:' '},
      {palavra:'º', imagem:' '},
  ...
  static letrasSmall = [ 
      ...
      {letra:'146', img:'../assets/img/sinais-braille-small/146-braille.png', imgMarcado:'../assets/img/sinais-braille-small/146-braille.png'},
      ...
      {letra:':', img:'../assets/img/sinais-braille-small/dois-pontos.png', imgMarcado:'../assets/img/sinais-braille-small/dois-pontos-d.png'},
      ...
      {letra:'multiplicacao', img:'../assets/img/sinais-braille-small/multiplicacao.png', imgMarcado:'../assets/img/sinais-braille-small/multiplicacao-d.png'},
